...
const initialState: MobileQueryState = { isMobileDevice: window.innerWidth <= 600 } ;

export const mobileQueryReducer = (state: MobileQueryState = initialState, action: Action): MobileQueryState => {
